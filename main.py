...
ST_URL = [
    "https://cricfree.sc/football-live-stream-5",
    "https://cricfree.sc/rugby-live-stream",
    "https://cricfree.sc/golf-live-streaming-"
]
...
if r.status_code == 200 and soup:
    ...
    print(Col.WARNING + "Récupération du programme en direct impossible" + Col.ENDC)
